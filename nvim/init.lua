...
-- Set the editor to use spaces instead of tabs
vim.cmd("set expandtab")

-- Set the number of spaces that a tab represents
vim.cmd("set tabstop=4")

-- Set the number of spaces to use for each level of indent
vim.cmd("set shiftwidth=4")

-- Set the cursor shape
-- vim.cmd("set guicursor=n-c-v")
...
-- Set extensions for coc.nvim
vim.cmd("let g:coc_global_extensions = [ 'coc-highlight', 'coc-python', 'coc-json', 'coc-clangd' ]")
...
--  saving shortcut
vim.cmd("nnoremap zz :update<cr>")
vim.cmd("inoremap zz <Esc>:update<cr>")
vim.cmd("nnoremap zx :wq<cr>")
vim.cmd("inoremap zx <Esc>:wq<cr>")
vim.cmd("nnoremap <leader>ca <C-W><C-O>")
